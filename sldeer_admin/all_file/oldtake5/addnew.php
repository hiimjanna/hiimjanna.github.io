...
<?php
	...
	{
		$n_data = $_POST['n_data'];// 名稱
		$n_title = $_POST['n_title'];// 內容 
		$n_contect = $_POST['n_contect'];// user 啟動
/*		
		...
		*/
		...
		if(!isset($errMSG))
		{
			$stmt = $db->prepare('INSERT INTO newall(n_data,n_title,n_contect) VALUES(:ndata, :ntitle, :ncontect)');
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
        ...
        <td><input class="form-control" type="date" name="n_data" placeholder="請輸入日期" value="<?php echo $username5; ?>" /></td>
    </tr>
    <tr>
    	<td><label class="control-label">新聞標題</label></td>
        <td><input class="form-control" type="text" name="n_title" placeholder="請輸入名稱" value="<?php echo $username5; ?>" /></td>
    </tr>
    
    
    <tr>
    	<td><label class="control-label">新聞內容.</label></td>
        <td><textarea class="form-control" name="n_contect" id="n_contect" rows="10"  cols="80" placeholder="請輸入內容" ></textarea>
       <!-- <input class="form-control" type="text" name="user_job" placeholder="請輸入內容" value="<?php echo $userjob5; ?>" /> -->
